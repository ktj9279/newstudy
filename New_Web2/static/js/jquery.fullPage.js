    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        $('figure').on('click', function (e) {
            ...
            //     $('#slideshow-keyword > table:first').fadeOut(500).next().fadeIn(500).end().appendTo('#slideshow-keyword');
            // }, 1000);
                $('#slideshow-keyword > table:first').hide().next().show().end().appendTo('#slideshow-keyword');
            }, 1000);
            $('.left-center-part #keywordSection').html(sectionTitle);
        })
        ...
        $(document).on('click', '#button-more2 , #indicator-scroll2', function(e){
            e.preventDefault();
        ...
        $('.showNewsContents').on('click',function (e) {
            ...
            $.ajax({
                ...
                url:"/showContents",
                success:function (result) {
                    $('#newsContents h3').text(result[0]);
                    $('#newsContents h5').text(String(result[1]).substr(51));
                    $('#newsContents a').attr('href',result[2]);
                }
            })
        })
